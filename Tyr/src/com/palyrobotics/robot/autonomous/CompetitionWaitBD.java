...
public class CompetitionWaitBD extends CommandGroup{
	public CompetitionWaitBD(DrivetrainController drive, ShooterController shooter) {
		sequentially(
				new ShooterDownHold(shooter),
				new CompetitionWaitBD.WaitFor(500),
				new ShooterDeadHold(shooter),
				new CompetitionWaitBD.WaitFor(9000),
