...
public class CompetitionMoatTwentyPointAuto extends CommandGroup{
	public CompetitionMoatTwentyPointAuto(DrivetrainController drive, ShooterController shooter,
		...
		sequentially(
				...
				new GenericDriveAuto(drive,false, 1100, 1.0f),
				new CompetitionMoatTwentyPointAuto.WaitFor(1000),
				new GenericTurnAngle(drive, 180, 1.0f, 2500),
				new CompetitionMoatTwentyPointAuto.WaitFor(1000),
				new SuccessiveAutoAlign(drive, 0.33f, 6500),
