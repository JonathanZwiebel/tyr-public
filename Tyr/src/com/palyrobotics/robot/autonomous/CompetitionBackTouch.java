...
public class CompetitionBackTouch extends CommandGroup{
	public CompetitionBackTouch(DrivetrainController drive, ShooterController shooter) {
		sequentially(
				new ShooterDownHold(shooter),
				new CompetitionBackTouch.WaitFor(500),
				new ShooterDeadHold(shooter),
				new GenericDriveAuto(drive,false, 8000, 0.2f)
		);
	}
