...
public class DrivetrainHardware implements DrivetrainSystems {
	private Motor leftFrontMotor = Hardware.Motors.talonSRX(2);
	private Motor leftBackMotor = Hardware.Motors.talonSRX(4);
	
	private Motor rightFrontMotor = Hardware.Motors.talonSRX(1);
	private Motor rightBackMotor = Hardware.Motors.talonSRX(3);
